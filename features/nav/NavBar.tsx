  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-bg/85 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center gap-1 px-6 py-3">
        ...
        <nav className="flex flex-1 items-center gap-0.5 overflow-x-auto [scrollbar-width:none] max-md:[mask-image:linear-gradient(90deg,#000_88%,transparent)] [&::-webkit-scrollbar]:hidden">
          {PRIMARY.map((l) => (
            <Link
              key={l.href}
